...
fn main() -> Result<(), std::io::Error> {
    ...
    account_lookup.into_iter().for_each(|(_, v)| {
        buffer
...
fn parse_accounts(text: &String) -> CHashMap<String, Account> {
...
fn process_transactions(
    accounts: &mut CHashMap<String, Account>,
...
fn apply_transaction(
    // account: ReadGuard<'_, String, Account>,
    account: &Account,
